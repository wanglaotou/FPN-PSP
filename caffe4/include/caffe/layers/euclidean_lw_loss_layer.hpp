#ifndef CAFFE_EUCLIDEAN_LW_LOSS_LAYER_HPP_
#define CAFFE_EUCLIDEAN_LW_LOSS_LAYER_HPP_
...
class EuclideanLwLossLayer : public LossLayer<Dtype> {
 public:
  explicit EuclideanLwLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "EuclideanLwLoss"; }
...
#endif  // CAFFE_EUCLIDEAN_LW_LOSS_LAYER_HPP_
