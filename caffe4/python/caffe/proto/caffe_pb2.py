...
EuclideanHardminingLossParameter = _reflection.GeneratedProtocolMessageType('EuclideanHardminingLossParameter', (_message.Message,), dict(
  DESCRIPTOR = _EUCLIDEANHARDMININGLOSSPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.EuclideanHardminingLossParameter)
  ))
_sym_db.RegisterMessage(EuclideanHardminingLossParameter)
