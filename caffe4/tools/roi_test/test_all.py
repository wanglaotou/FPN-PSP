...
net_file = '/ssd1/crowd_count/luohongling/MCNN2.3/2017-08-11/pretrain1_expo/deploy.prototxt'
caffe_model = '/ssd1/crowd_count/luohongling/MCNN2.3/2017-08-11/pretrain1_expo/models/expo_iter_400000.caffemodel'
...
def demoDMap(filepath):
    ...
    saveFile = '/ssd1/crowd_count/luohongling/MCNN2.3/2017-08-11/pretrain1_expo/test/All_average_40w.txt'
    ...
    for m in mapList:
        ...
        scene_id = m[0][0:6]
        if(scene_id == '104207' or scene_id == '200608' or scene_id == '200702' or scene_id == '202201' or scene_id == '500717'):
...
#demoDMap('/ssd1/crowd_count/luohongling/data/merge_data/test_data')
